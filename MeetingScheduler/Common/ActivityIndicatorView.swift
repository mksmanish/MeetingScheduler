...
class ActivityIndicatorView : NVActivityIndicatorViewable{
    ...
    static func createViewOnFrame(frame:CGRect,onView:UIView){
        indicatorView = NVActivityIndicatorView(frame: CGRect(x: 0, y: 0, width: 40, height: 40), type: .ballClipRotateMultiple, color: .green)
...
extension UIViewController {
    var activityData : ActivityData {
        get { return ActivityData(size : CGSize(width: 40, height: 40),type: .ballClipRotateMultiple, color: .green) }
    }
